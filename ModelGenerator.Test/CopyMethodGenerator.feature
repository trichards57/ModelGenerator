Feature: Generating class copy methods
	Clone method should create a new item
	...
	ToItem method should copy all existing properties to it except navigation properties
